...
<div class="row">
    <div class="col-sm-12 col-md-1 col-12">
        <div class="nav nav-pills auction_navs me-3 mt-5" id="v-pills-tab" role="tablist"
            aria-orientation="vertical">
            <a class="nav-link text-start active" id="v-pills-profile-tab" data-bs-toggle="pill"
            data-bs-target="#v-pills-profile" type="button" role="tab"
            aria-controls="v-pills-profile" aria-selected="false">Profile</a>
            <a class="nav-link text-start" id="v-pills-auctions-tab" data-bs-toggle="pill"
            data-bs-target="#v-pills-auctions" type="button" role="tab"
            aria-controls="v-pills-auctions" aria-selected="false">Auctions</a>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            <form action="">
                                ...
                                <div class=" d-flex px-0 pt-5">
                                    <p>Public/Private</p>
                                    <label  class="onoffbtn ms-2"><input type="checkbox"></label>
                                </div>
                            </form>
                        </div>
                    </div>
...
<form action="">
    ...
    <div class="modal-body">
        <div class="mb-3 editprofile">
            <label for="exampleFormControlTextarea0" class="form-label">Phone book</label>
            <textarea class="form-control shadow-none" id="exampleFormControlTextarea0" rows="3"></textarea>
        </div>
    </div>
    <div class="modal-footer editprofile">
