                                    ...
                                    <div class="msg-body">
                                        <ul class="p-0">
                                            <li class="sender d-flex justify-content-between">
                                                <img class="rounded-pill me-2 align-self-start"
                                                    src="assets/images/user/user1.png" alt="user img" width="38"
                                                    height="38">
                                                <p> Hi, I would like to ask you some questions about the Rolex you
                                                    listed today </p>
                                            </li>
                                            <li class="sender d-flex justify-content-between"> <img
                                                    class="rounded-pill me-2 align-self-start"
                                                    src="assets/images/user/user1.png" alt="user img" width="38"
                                                    height="38">
                ...
                <p class="">Lorem ipsum dolor sit amet, consectetur</p>
                                ...
                                <div class="send-box">
                                 ...
                                 <div class="sendbtn">
                                      ...
                                      <div class="plusbtn">
                                          <button class="btn shadow-none" type="button"><i class="fa-solid fa-plus"></i>
                                            </button>
                                      </div>
